...
import org.example.userserviceproject.security.models.AuthorizationConsent;
import org.example.userserviceproject.security.repositories.AuthorizationConsentRepository;
...
public class JpaOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
    ...
    public OAuth2AuthorizationConsent findById(String registeredClientId, String principalName) {
        ...
        return this.authorizationConsentRepository.findByRegisteredClientIdAndPrincipalName(
                registeredClientId, principalName).map(entity -> toObject((AuthorizationConsent) entity)).orElse(null);
    }
